SSDLC Compliance Report: Atlas Kubernetes Operator Manager v1.3.0
=================================================================

- Release Creators: andrei
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v1.3.0, 2025-07-13.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:1.3.0 SIGNATURE_REPO=mongodb/signatures
    ```
