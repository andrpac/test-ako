SSDLC Compliance Report: Atlas Kubernetes Operator Manager v1.2.3
=================================================================

- Release Creators: and
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v1.2.3, 2025-07-13.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:1.2.3 SIGNATURE_REPO=mongodb/signatures
    ```
