SSDLC Compliance Report: Atlas Kubernetes Operator Manager v1.0.0
=================================================================

- Release Creators: André
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v1.0.0, 2025-07-13.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:1.0.0 SIGNATURE_REPO=mongodb/signatures
    ```
