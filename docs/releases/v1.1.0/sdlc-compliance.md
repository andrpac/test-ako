SSDLC Compliance Report: Atlas Kubernetes Operator Manager v1.1.0
=================================================================

- Release Creators: andrpac
...
- **Product and Release Name**
    ...
    - Atlas Kubernetes Operator v1.1.0, 2025-07-12.
...
- **Release Signature Report**
  ...
  - Self-verification shortcut:
    ```shell
    make verify IMG=mongodb/mongodb-atlas-kubernetes-operator:1.1.0 SIGNATURE_REPO=mongodb/signatures
    ```
